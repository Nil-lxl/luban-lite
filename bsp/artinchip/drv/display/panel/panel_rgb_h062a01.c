...
static int panel_enable(struct aic_panel *panel) {
    ...
    panel_spi_data_wr(0x8D);//85-mike0925
    panel_spi_cmd_wr(0xB8);
    panel_spi_data_wr(0x33);//32-mike0925
    panel_spi_cmd_wr(0xB9);
    panel_spi_data_wr(0x10);
    panel_spi_cmd_wr(0xBB);//mike0925
...
static struct aic_panel_funcs h062a01_funcs = {
...
static struct display_timing h062a01_timing = {
...
struct aic_panel rgb_h062a01 = {
    .name = "panel-h062a01",
    .timings = &h062a01_timing,
    .funcs = &h062a01_funcs,
    .rgb = &rgb,
