...
static int panel_enable(struct aic_panel *panel) {
    ...
    panel_dsi_generic_send_seq(panel, 0xC0, 0xE9, 0x03);
    panel_dsi_generic_send_seq(panel, 0xC1, 0x10, 0x0C);
    panel_dsi_generic_send_seq(panel, 0xC2, 0x20, 0x07);
    panel_dsi_generic_send_seq(panel, 0xCC, 0x10);
    panel_dsi_generic_send_seq(panel, 0xB0, 0x00, 0x1E, 0x25, 0x0D, 0x10, 0x06, 0x0E, 0x09, 0x08, 0x28, 0x03, 0x0F, 0x0D, 0x2D, 0x31, 0x1C);
    panel_dsi_generic_send_seq(panel, 0xB1, 0x00, 0x1F, 0x25, 0x0D, 0x11, 0x06, 0x0D, 0x08, 0x07, 0x23, 0x03, 0x11, 0x10, 0x27, 0x31, 0x1C);
    ...
    panel_dsi_generic_send_seq(panel, 0xB2, 0x8B);
    panel_dsi_generic_send_seq(panel, 0xB3, 0x80);
    panel_dsi_generic_send_seq(panel, 0xB5, 0x4F);
    panel_dsi_generic_send_seq(panel, 0xB7, 0x87);
    panel_dsi_generic_send_seq(panel, 0xB8, 0x22);
    panel_dsi_generic_send_seq(panel, 0xC0, 0x0E);
    ...
    panel_dsi_generic_send_seq(panel, 0xE1, 0x06, 0xA0, 0x08, 0xA0, 0x05, 0xA0, 0x07, 0xA0, 0x00, 0x44, 0x44);
    panel_dsi_generic_send_seq(panel, 0xE2, 0x30, 0x30, 0x44, 0x44, 0x6E, 0xA0, 0x00, 0x00, 0x6E, 0xA0, 0x00, 0x00);
    panel_dsi_generic_send_seq(panel, 0xE3, 0x00, 0x00, 0x33, 0x33);
    panel_dsi_generic_send_seq(panel, 0xE4, 0x44, 0x44);
    panel_dsi_generic_send_seq(panel, 0xE5, 0x0D, 0x69, 0x0A, 0xA0, 0x0F, 0x6B, 0x0A, 0xA0, 0x09, 0x65, 0x0A, 0xA0, 0x0B, 0x67, 0x0A, 0xA0);
    panel_dsi_generic_send_seq(panel, 0xE6, 0x00, 0x00, 0x33, 0x33);
    panel_dsi_generic_send_seq(panel, 0xE7, 0x44, 0x44);
    panel_dsi_generic_send_seq(panel, 0xE8, 0x0C, 0x68, 0x0A, 0xA0, 0x0E, 0x6A, 0x0A, 0xA0, 0x08, 0x64, 0x0A, 0xA0, 0x0A, 0x66, 0x0A, 0xA0);
    panel_dsi_generic_send_seq(panel, 0xE9, 0x36, 0x00);
    panel_dsi_generic_send_seq(panel, 0xEB, 0x00, 0x01, 0xE4, 0xE4, 0x44, 0x88, 0x40);
    panel_dsi_generic_send_seq(panel, 0xED, 0xFF, 0x45, 0x67, 0xFA, 0x01, 0x2B, 0xCF, 0xFF, 0xFF, 0xFC, 0xB2, 0x10, 0xAF, 0x76, 0x54, 0xFF);
    panel_dsi_generic_send_seq(panel, 0xEF, 0x08, 0x08, 0x08, 0x45, 0x3F, 0x1F);
    panel_dsi_generic_send_seq(panel, 0xFF, 0x77, 0x01, 0x00, 0x00, 0x13);
...
static struct display_timing h030a2_timing = {
    .pixelclock = 31 * 1000 * 1000,
    .hactive = 480,
    .hfront_porch = 40,
    .hback_porch = 40,
    .hsync_len = 4,
...
struct aic_panel dsi_h030a2 = {
    .name = "panel-h030a2",
    .timings = &h030a2_timing,
    .funcs = &panel_funcs,
    .dsi = &dsi,
