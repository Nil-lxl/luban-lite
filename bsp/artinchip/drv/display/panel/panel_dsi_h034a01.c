...
static int panel_enable(struct aic_panel *panel) {
    ...
    panel_dsi_dcs_send_seq(panel, 0x29, 0xC3);
    panel_dsi_dcs_send_seq(panel, 0x2a, 0x1F);
    panel_dsi_dcs_send_seq(panel, 0x37, 0x9C);//5.5V
    panel_dsi_dcs_send_seq(panel, 0x38, 0xA7);//-5.5V
    panel_dsi_dcs_send_seq(panel, 0x39, 0x51);//vcom
    ...
    panel_dsi_dcs_send_seq(panel, 0x98, 0xCA);
    panel_dsi_dcs_send_seq(panel, 0x99, 0x51);
    panel_dsi_dcs_send_seq(panel, 0x9a, 0xC1);
    ...
    panel_dsi_dcs_send_seq(panel, 0xF0, 0x00); //BIST 07-0F
    panel_dsi_dcs_send_seq(panel, 0xF6, 0xC0);
    panel_dsi_dcs_send_seq(panel, 0xC0, 0x00);//ADD FOR ESD 
    ...
    panel_dsi_dcs_send_seq(panel, 0xB1, 0x04);
    panel_dsi_dcs_send_seq(panel, 0xD1, 0x0E);
    panel_dsi_dcs_send_seq(panel, 0xB4, 0x2C);
    panel_dsi_dcs_send_seq(panel, 0xD4, 0x36);
    panel_dsi_dcs_send_seq(panel, 0xB2, 0x04);
    panel_dsi_dcs_send_seq(panel, 0xD2, 0x0C);
    panel_dsi_dcs_send_seq(panel, 0xB3, 0x34);
    panel_dsi_dcs_send_seq(panel, 0xD3, 0x2C);
    panel_dsi_dcs_send_seq(panel, 0xB6, 0x12);
    panel_dsi_dcs_send_seq(panel, 0xD6, 0x18);
    panel_dsi_dcs_send_seq(panel, 0xB7, 0x37);
    panel_dsi_dcs_send_seq(panel, 0xD7, 0x3D);
    panel_dsi_dcs_send_seq(panel, 0xC1, 0x04);
    panel_dsi_dcs_send_seq(panel, 0xE1, 0x08);
    panel_dsi_dcs_send_seq(panel, 0xB8, 0x0A);
    panel_dsi_dcs_send_seq(panel, 0xD8, 0x0C);
    panel_dsi_dcs_send_seq(panel, 0xB9, 0x01);
    panel_dsi_dcs_send_seq(panel, 0xD9, 0x03);
    panel_dsi_dcs_send_seq(panel, 0xBD, 0x13);
    panel_dsi_dcs_send_seq(panel, 0xDD, 0x13);
    panel_dsi_dcs_send_seq(panel, 0xBC, 0x11);
    panel_dsi_dcs_send_seq(panel, 0xDC, 0x11);
    panel_dsi_dcs_send_seq(panel, 0xBB, 0x0F);
    panel_dsi_dcs_send_seq(panel, 0xDB, 0x0F);
    panel_dsi_dcs_send_seq(panel, 0xBA, 0x10);
    panel_dsi_dcs_send_seq(panel, 0xDA, 0x10);
    panel_dsi_dcs_send_seq(panel, 0xBE, 0x16);
    panel_dsi_dcs_send_seq(panel, 0xDE, 0x1E);
    panel_dsi_dcs_send_seq(panel, 0xBF, 0x0D);
    panel_dsi_dcs_send_seq(panel, 0xDF, 0x15);
    panel_dsi_dcs_send_seq(panel, 0xC0, 0x13);
    panel_dsi_dcs_send_seq(panel, 0xE0, 0x1D);
    ...
    panel_dsi_dcs_send_seq(panel, 0x0A, 0x83);
    panel_dsi_dcs_send_seq(panel, 0x0B, 0x84);
    ...
    panel_dsi_dcs_send_seq(panel, 0x2A, 0x27);
    panel_dsi_dcs_send_seq(panel, 0x2b, 0x27);

    panel_dsi_dcs_send_seq(panel, 0x34, 0x11);
    panel_dsi_dcs_send_seq(panel, 0x35, 0x01);
    panel_dsi_dcs_send_seq(panel, 0x36, 0x01);
    panel_dsi_dcs_send_seq(panel, 0x37, 0x03);

    panel_dsi_dcs_send_seq(panel, 0x40, 0x81);
    panel_dsi_dcs_send_seq(panel, 0x41, 0x82);
    panel_dsi_dcs_send_seq(panel, 0x42, 0x01);
    panel_dsi_dcs_send_seq(panel, 0x43, 0x80);

    panel_dsi_dcs_send_seq(panel, 0x44, 0x33);
    panel_dsi_dcs_send_seq(panel, 0x45, 0x25);
    panel_dsi_dcs_send_seq(panel, 0x46, 0x24);
    panel_dsi_dcs_send_seq(panel, 0x47, 0x33);
    panel_dsi_dcs_send_seq(panel, 0x48, 0x27);
    panel_dsi_dcs_send_seq(panel, 0x49, 0x26);

    panel_dsi_dcs_send_seq(panel, 0x50, 0x85);
    panel_dsi_dcs_send_seq(panel, 0x51, 0x86);
    panel_dsi_dcs_send_seq(panel, 0x52, 0x83);
    panel_dsi_dcs_send_seq(panel, 0x53, 0x84);

    panel_dsi_dcs_send_seq(panel, 0x54, 0x33);
    panel_dsi_dcs_send_seq(panel, 0x55, 0x21);
    panel_dsi_dcs_send_seq(panel, 0x56, 0x20);
    panel_dsi_dcs_send_seq(panel, 0x57, 0x33);
    panel_dsi_dcs_send_seq(panel, 0x58, 0x23);
    panel_dsi_dcs_send_seq(panel, 0x59, 0x22);

    panel_dsi_dcs_send_seq(panel, 0x7e, 0x03);
    ...
    panel_dsi_dcs_send_seq(panel, 0x85, 0x04);
    panel_dsi_dcs_send_seq(panel, 0x86, 0x04);
    panel_dsi_dcs_send_seq(panel, 0x87, 0x05);
    panel_dsi_dcs_send_seq(panel, 0x88, 0x05);
    panel_dsi_dcs_send_seq(panel, 0x89, 0x06);
    panel_dsi_dcs_send_seq(panel, 0x8A, 0x06);
    panel_dsi_dcs_send_seq(panel, 0x8B, 0x07);
    panel_dsi_dcs_send_seq(panel, 0x8C, 0x07);
    panel_dsi_dcs_send_seq(panel, 0x8D, 0x0f);
    panel_dsi_dcs_send_seq(panel, 0x8E, 0x0f);
    panel_dsi_dcs_send_seq(panel, 0x8F, 0x0d);
    panel_dsi_dcs_send_seq(panel, 0x90, 0x0d);
    panel_dsi_dcs_send_seq(panel, 0x91, 0x0c);
    panel_dsi_dcs_send_seq(panel, 0x92, 0x0c);
    ...
    panel_dsi_dcs_send_seq(panel, 0x9B, 0x04);
    panel_dsi_dcs_send_seq(panel, 0x9C, 0x04);
    panel_dsi_dcs_send_seq(panel, 0x9D, 0x05);
    panel_dsi_dcs_send_seq(panel, 0x9E, 0x05);
    panel_dsi_dcs_send_seq(panel, 0x9F, 0x06);
    panel_dsi_dcs_send_seq(panel, 0xA0, 0x06);
    panel_dsi_dcs_send_seq(panel, 0xA1, 0x07);
    panel_dsi_dcs_send_seq(panel, 0xA2, 0x07);
    panel_dsi_dcs_send_seq(panel, 0xA3, 0x0f);
    panel_dsi_dcs_send_seq(panel, 0xA4, 0x0f);
    panel_dsi_dcs_send_seq(panel, 0xA5, 0x0d);
    panel_dsi_dcs_send_seq(panel, 0xA6, 0x0d);
    panel_dsi_dcs_send_seq(panel, 0xA7, 0x0c);
    panel_dsi_dcs_send_seq(panel, 0xA8, 0x0c);
...
static struct display_timing h034a01_timing = {
