...
static const u8 h027a01_commands[] = {
...
static struct aic_panel_funcs h027a01_funcs = {
...
static struct display_timing h027a01_timing = {
...
static struct panel_dbi dbi = {
    ...
    .commands = {
        .buf = h027a01_commands,
        .len = ARRAY_SIZE(h027a01_commands),
    }
};

struct aic_panel dbi_h027a01 = {
    .name = "panel-h027a01",
    .timings = &h027a01_timing,
    .funcs = &h027a01_funcs,
    .dbi = &dbi,
