...
#elif defined(CHIP_SELECT_AIC8800DL)
#define CONFIG_CHIPID_SELECT   PRODUCT_ID_AIC8800DC
#else
#define CONFIG_CHIPID_SELECT   PRODUCT_ID_AIC8800D80
#endif
...
#elif defined(CONFIG_AIC8800_FTTEST_MODE)
#define CONFIG_WIFIMODE_SELECT WIFI_MODE_FTTEST
#else
