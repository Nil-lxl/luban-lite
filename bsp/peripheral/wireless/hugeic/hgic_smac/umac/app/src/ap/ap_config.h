...
#include "utils/ip_addr.h" //porting
...
struct mac_acl_entry {
	macaddr addr;
	//struct vlan_description vlan_id; //porting
};
...
#define MKA_PSK_SET (MKA_PSK_SET_CKN | MKA_PSK_SET_CAK)
	...
	int edca_auto; //porting
    struct {
        struct hostapd_wmm_ac_params params[4];
    }edca_auto_params[8];
};
