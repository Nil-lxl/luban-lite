...
//#define wpa_printf(l,fmt,...) do { if(l>=wpa_debug_level) libc_printf(fmt"\r\n", ##__VA_ARGS__);} while (0) 
...
#define wpa_dbg(c,l,args...) wpa_printf(l,args)
#define wpa_printf(l,fmt,...) do { if(l>=wpa_debug_level) PRINTF(fmt"\r\n", ##__VA_ARGS__);} while (0) 
...
//#define wpa_msg(c,l,args,...) do { if(l>=wpa_debug_level) PRINTF(args"\r\n", ##__VA_ARGS__);} while (0)
...
//#define wpa_printf(l,fmt,...) do { if(l>=wpa_debug_level) PRINTF(fmt"\r\n", ##__VA_ARGS__);} while (0) 
//#define wpa_msg(c,l,args,...) do { if(l>=wpa_debug_level) PRINTF(args"\r\n", ##__VA_ARGS__);} while (0)
//#define wpa_msg_ctrl(c,l,args,...) do { if(l>=wpa_debug_level) PRINTF(args"\r\n", ##__VA_ARGS__);} while (0)
//#define wpa_msg_global(c,l,args,...) do { if(l>=wpa_debug_level) PRINTF(args"\r\n", ##__VA_ARGS__);} while (0)
//#define wpa_msg_global_ctrl(c,l,args,...) do { if(l>=wpa_debug_level) PRINTF(args"\r\n", ##__VA_ARGS__);} while (0)
//#define wpa_msg_no_global(c,l,args,...) do { if(l>=wpa_debug_level) PRINTF(args"\r\n", ##__VA_ARGS__);} while (0)
//#define wpa_msg_global_only(c,l,args,...) do { if(l>=wpa_debug_level) PRINTF(args"\r\n", ##__VA_ARGS__);} while (0)
//#define wpa_msg_register_cb(f) do { } while (0)
//#define wpa_msg_register_ifname_cb(f) do { } while (0)
