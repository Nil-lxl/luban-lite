...
#include "utils/os.h"  //porting

#ifdef WPA_SUPPLICANT_RTOS /*porting*/
...
#ifndef MAC2STR
#define MAC2STR(a) (a)[0]&0xff, (a)[1]&0xff, (a)[2]&0xff, (a)[3]&0xff, (a)[4]&0xff, (a)[5]&0xff //porting
...
int wpa_get_line(char *buff, char *s, int size); //porting
