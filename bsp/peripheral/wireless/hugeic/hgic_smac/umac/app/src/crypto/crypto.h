 ...
 * Returns: 0 on success, -1 on failure
 */
int os_des_encrypt(const u8 *clear, const u8 *key, u8 *cypher);
 ...
 * Returns: 0 on success, -1 on failure
 */
int os_aes_encrypt(void *ctx, const u8 *plain, u8 *crypt);
 ...
 * Returns: 0 on success, -1 on failure
 */
int os_aes_decrypt(void *ctx, const u8 *crypt, u8 *plain);
...
#define des_encrypt     os_des_encrypt
#define des_decrypt     os_des_decrypt
