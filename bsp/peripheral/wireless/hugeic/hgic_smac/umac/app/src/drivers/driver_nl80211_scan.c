...
void wpa_driver_nl80211_dump_scan(struct wpa_driver_nl80211_data *drv)//porting
{
	struct nl_msg *msg;
				   ...
				   struct wpa_driver_scan_params *params)
{
	...
	if (params->p2p_probe) {
		...
		wpa_printf(MSG_DEBUG, "nl80211: P2P probe - mask SuppRates");
            ...
            PRINTF("%s:nl80211: P2P probe - mask SuppRates\n",__FUNCTION__);
