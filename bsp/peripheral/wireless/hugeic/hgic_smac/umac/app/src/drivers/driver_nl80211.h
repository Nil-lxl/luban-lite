...
#if 0 //ndef NL_CAPABILITY_VERSION_3_5_0
...
//porting
    void (*event)(void *ctx, enum wpa_event_type event, union wpa_event_data *data);
    void (*global_event)(void *ctx, enum wpa_event_type event, union wpa_event_data *data);
