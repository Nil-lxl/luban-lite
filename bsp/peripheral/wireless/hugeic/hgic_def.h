...
#define VERSOIN_SHOW(name) do{\
        printk("** HUGE-IC WLAN Card Driver("name")"HGIC_VERSION"-"SVN_VERSION",%s,%s\r\n",__DATE__,__TIME__);\
    }while(0)
...
#define hgic_enter()       PRINTF("enter %s\r\n", __FUNCTION__)
#define hgic_leave()       PRINTF("leave %s\r\n", __FUNCTION__)
