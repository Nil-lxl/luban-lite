...
#define netif_carrier_ok(n) (0)
#define netif_carrier_off(n)
#define netif_carrier_on(n)
...
#define netdev_info(d, f...) printk(f)
#define eth_type_trans(skb,dev) get_unaligned_be16((skb)->data+12) 
