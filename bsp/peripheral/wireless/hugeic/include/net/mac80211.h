...
//#include <linux/bug.h>   /*porting*/
#include <linux/kernel.h>
#include <linux/if_ether.h>
#include <linux/skbuff.h>
#include <linux/ieee80211.h>
#include <net/cfg80211.h>
//#include <net/codel.h>   /*porting*/
//#include <net/ieee80211_radiotap.h>   /*porting*/
    ...
    union {
        struct {
            union {
                ...
                unsigned long jiff;   /*porting*/
            };
            /* NB: vif can be NULL for injected frames */
            struct ieee80211_vif *vif;
            struct ieee80211_key_conf *hw_key;
            u32 flags;
            //codel_time_t enqueue_time;   /*porting*/
        } control;
        struct {
            u64 cookie;
        } ack;
...
struct ieee80211_vif {
    ...
    //struct ieee80211_txq *txq;   /*porting*/
    ...
    //bool txqs_stopped[IEEE80211_NUM_ACS];   /*porting*/
...
struct ieee80211_sta {
    ...
    //struct ieee80211_txq *txq[IEEE80211_NUM_TIDS + 1];   /*porting*/
