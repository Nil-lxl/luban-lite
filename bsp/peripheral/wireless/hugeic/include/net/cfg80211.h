...
#include <linux/string.h>   //porting
#include <linux/debugfs.h>
#include <linux/list.h>
#include <linux/netdevice.h>  //porting
#include <linux/netlink.h>
#include <linux/skbuff.h>
#include <linux/workqueue.h>  //porting
#include <linux/mutex.h>      //porting
#include <linux/nl80211.h>
#include <linux/if_ether.h>
#include <linux/ieee80211.h>
//#include <linux/net.h>       //porting
...
#if 1//IS_ENABLED(CONFIG_CFG80211)  //porting
/**
...
struct cfg80211_ops {
    ...
    int (*set_channel)(struct wiphy *wiphy,      /*porting*/
                       struct wireless_dev *wdev,
				       struct cfg80211_chan_def *chandef);
};
...
#else
#define wiphy_net(w) (0)
#define wiphy_net_set(...)
#endif
...
#else
#define set_wiphy_dev(w,d)
#define wiphy_dev(w) (0)
#endif
...
struct wireless_dev {
	struct wiphy *wiphy;
	struct ieee80211_hw *hw;  /*porting*/
	enum nl80211_iftype iftype;
...
#if 1 /*porting*/
bool cfg80211_rx_eapol(struct wireless_dev *wdev, int freq, int sig_mbm,
		      const u8 *buf, size_t len, gfp_t gfp);

int cfg80211_init(void);
void cfg80211_exit(void);
