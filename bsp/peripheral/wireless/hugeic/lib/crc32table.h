...
static u32 __cacheline_aligned crc32table_le[1][256] = {{
...
static const u32 __cacheline_aligned crc32table_be[1][256] = {{
...
#if 0
static u32 __cacheline_aligned crc32ctable_le[1][256] = {{
