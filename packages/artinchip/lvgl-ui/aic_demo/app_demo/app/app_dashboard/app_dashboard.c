...
#define DASHBOARD_PATH(y) CONN(LVGL_DIR"image/dashboard/", y)
#define DASHBOARD_DIR LVGL_DIR"image/dashboard/"

static lv_obj_t *dashboard_ui;
...
static void speed_callback(lv_timer_t *tmr)
{
    ...
    if (cur_low != last_low) {
        ui_snprintf(data_str, "%sspeed_num/s_%d.png", LVGL_DIR"image/dashboard/", speed_num % 10);
...
static void trip_callback(lv_timer_t *tmr)
{
    ...
    ui_snprintf(data_str, "%smileage/%d.png", LVGL_DIR"image/dashboard/", num[0]);
    lv_img_set_src(img_trip_0, data_str);

    ui_snprintf(data_str, "%smileage/%d.png", LVGL_DIR"image/dashboard/", num[1]);
    lv_img_set_src(img_trip_1, data_str);

    ui_snprintf(data_str, "%smileage/%d.png", LVGL_DIR"image/dashboard/", num[2]);
    lv_img_set_src(img_trip_2, data_str);

    ui_snprintf(data_str, "%smileage/%d.png", LVGL_DIR"image/dashboard/", num[3]);
...
static void dashboard_exit_cb(lv_event_t *e) {
...
lv_obj_t *app_dashboard_init() {
...
#ifdef KERNEL_RTTHREAD
    bg_cpu = lv_label_create(dashboard_ui);
    ...
    lv_img_set_src(img_speed_high, DASHBOARD_PATH(speed_num/s_0.png));
    lv_obj_set_pos(img_speed_high, 450, 280);

    img_speed_low = lv_img_create(dashboard_ui);
    lv_img_set_src(img_speed_low, DASHBOARD_PATH(speed_num/s_0.png));
    lv_obj_set_pos(img_speed_low, 520, 280);

    img_speed_km = lv_img_create(dashboard_ui);
    lv_img_set_src(img_speed_km, DASHBOARD_PATH(speed_num/s_kmh.png));
    lv_obj_set_pos(img_speed_km, 470, 370);

    lv_obj_t *img_t1 = lv_img_create(dashboard_ui);
    lv_img_set_src(img_t1, DASHBOARD_PATH(head/t_1.png));
    lv_obj_set_pos(img_t1, 16, 50);

    lv_obj_t *img_t2 = lv_img_create(dashboard_ui);
    lv_img_set_src(img_t2, DASHBOARD_PATH(head/t_2.png));
    lv_obj_set_pos(img_t2, 66, 50);

    lv_obj_t *img_t3 = lv_img_create(dashboard_ui);
    lv_img_set_src(img_t3, DASHBOARD_PATH(head/t_3.png));
    lv_obj_set_pos(img_t3, 160, 8);

    lv_obj_t *img_t4 = lv_img_create(dashboard_ui);
    lv_img_set_src(img_t4, DASHBOARD_PATH(head/t_4.png));
    lv_obj_set_pos(img_t4, 220, 8);

    lv_obj_t *img_t12 = lv_img_create(dashboard_ui);
    lv_img_set_src(img_t12, DASHBOARD_PATH(head/t_12.png));
    lv_obj_set_pos(img_t12, 414, 8);

    lv_obj_t *img_t5 = lv_img_create(dashboard_ui);
    lv_img_set_src(img_t5, DASHBOARD_PATH(head/t_5.png));
    lv_obj_set_pos(img_t5, 770, 8);

    lv_obj_t *img_t6 = lv_img_create(dashboard_ui);
    lv_img_set_src(img_t6, DASHBOARD_PATH(head/t_6.png));
    lv_obj_set_pos(img_t6, 822, 8);

    lv_obj_t *img_t8 = lv_img_create(dashboard_ui);
    lv_img_set_src(img_t8, DASHBOARD_PATH(head/t_8.png));
    lv_obj_set_pos(img_t8, 878, 8);

    lv_obj_t *img_b1 = lv_img_create(dashboard_ui);
    lv_img_set_src(img_b1, DASHBOARD_PATH(end/b_1.png));
    lv_obj_set_pos(img_b1, 82, 528);

    lv_obj_t *img_b2 = lv_img_create(dashboard_ui);
    lv_img_set_src(img_b2, DASHBOARD_PATH(end/b_2.png));
    lv_obj_set_pos(img_b2, 140, 528);

    lv_obj_t *img_b3 = lv_img_create(dashboard_ui);
    lv_img_set_src(img_b3, DASHBOARD_PATH(end/b_3.png));
    lv_obj_set_pos(img_b3, 202, 528);

    lv_obj_t *img_b4 = lv_img_create(dashboard_ui);
    lv_img_set_src(img_b4, DASHBOARD_PATH(end/b_4.png));
    lv_obj_set_pos(img_b4, 262, 528);

    lv_obj_t *img_b5 = lv_img_create(dashboard_ui);
    lv_img_set_src(img_b5, DASHBOARD_PATH(end/b_5.png));
    lv_obj_set_pos(img_b5, 322, 528);

    lv_obj_t *img_b6 = lv_img_create(dashboard_ui);
    lv_img_set_src(img_b6, DASHBOARD_PATH(end/b_6.png));
    lv_obj_set_pos(img_b6, 656, 528);

    lv_obj_t *img_b7 = lv_img_create(dashboard_ui);
    lv_img_set_src(img_b7, DASHBOARD_PATH(end/b_7.png));
    lv_obj_set_pos(img_b7, 720, 528);

    lv_obj_t *img_b8 = lv_img_create(dashboard_ui);
    lv_img_set_src(img_b8, DASHBOARD_PATH(end/b_8.png));
    lv_obj_set_pos(img_b8, 782, 528);

    lv_obj_t *img_b9 = lv_img_create(dashboard_ui);
    lv_img_set_src(img_b9, DASHBOARD_PATH(end/b_9.png));
    lv_obj_set_pos(img_b9, 838, 528);

    int trip_offset = 429;
    img_trip = lv_img_create(dashboard_ui);
    lv_img_set_src(img_trip, DASHBOARD_PATH(mileage/trip.png));
    lv_obj_set_pos(img_trip, trip_offset, 534);

    img_trip_0 = lv_img_create(dashboard_ui);
    lv_img_set_src(img_trip_0, DASHBOARD_PATH(mileage/0.png));
    lv_obj_set_pos(img_trip_0, 65 + trip_offset, 534);

    img_trip_1 = lv_img_create(dashboard_ui);
    lv_img_set_src(img_trip_1, DASHBOARD_PATH(mileage/0.png));
    lv_obj_set_pos(img_trip_1, 80 + trip_offset, 534);

    img_trip_2 = lv_img_create(dashboard_ui);
    lv_img_set_src(img_trip_2, DASHBOARD_PATH(mileage/9.png));
    lv_obj_set_pos(img_trip_2, 95 + trip_offset, 534);

    img_trip_3 = lv_img_create(dashboard_ui);
    lv_img_set_src(img_trip_3, DASHBOARD_PATH(mileage/8.png));
    lv_obj_set_pos(img_trip_3, 110 + trip_offset, 534);

    img_trip_km = lv_img_create(dashboard_ui);
    lv_img_set_src(img_trip_km, DASHBOARD_PATH(mileage/km.png));
    ...
    lv_obj_add_event_cb(dashboard_ui, dashboard_exit_cb, LV_EVENT_ALL, NULL);
