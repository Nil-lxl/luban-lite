...
struct aic_pinmux aic_pinmux_config[] = {
...
#endif
#if defined(AIC_USING_QSPI2) && defined(AIC_SYSCFG_SIP_FLASH_ENABLE) && !defined(AIC_USING_SDMC0) && !defined AIC_RGB_LED_WS2812B
    /* qspi2 */
...
#endif
#if defined AIC_USING_QSPI2 && defined AIC_RGB_LED_WS2812B
    ...
    {1, PIN_PULL_UP, 3, "PD.11"},   //WIFI ENABLE
    {1, PIN_PULL_UP, 3, "PD.12"},   //BT ENABLE
    {1, PIN_PULL_UP, 3, "PD.13"},   //HOST WAKE BT
    {1, PIN_PULL_UP, 3, "PD.14"},   //BT WAKE HOST
#endif
    ...
    {1, PIN_PULL_DIS, 3, "PB.1"},   //LCD RESET
    {1, PIN_PULL_UP, 3, "PE.15"},  //SPI-CS
    {1, PIN_PULL_DIS, 3, "PE.14"},  //SPI-SCL
    {1, PIN_PULL_DIS, 3, "PE.13"},  //SPI-SDA
    /* RGB 888 */
