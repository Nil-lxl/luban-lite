...
struct aic_pinmux aic_pinmux_config[] = {
   ...
   {1, PIN_PULL_DIS, 3, "PD.6"},   // BT_PWR_ON
    ...
    {1, PIN_PULL_UP, 3, "PD.3"},        //LCD IOVCC
    {1, PIN_PULL_DIS, 3, "PD.17"},      //LCD RST
    {4, PIN_PULL_DIS, 3, "PD.18"},      //D0N
    {4, PIN_PULL_DIS, 3, "PD.19"},      //D0P
    {4, PIN_PULL_DIS, 3, "PD.20"},      //D1N
    {4, PIN_PULL_DIS, 3, "PD.21"},      //D1P
    {4, PIN_PULL_DIS, 3, "PD.22"},      //CLKN
    {4, PIN_PULL_DIS, 3, "PD.23"},      //CLKP
    {4, PIN_PULL_DIS, 3, "PD.24"},      //D2N
    {4, PIN_PULL_DIS, 3, "PD.25"},      //D2P
    {4, PIN_PULL_DIS, 3, "PD.26"},      //D3N
    {4, PIN_PULL_DIS, 3, "PD.27"},      //D3P
#endif
