...
struct aic_pinmux aic_pinmux_config[] = {
    ...
    {6, PIN_PULL_DIS, 3, "PD.0"},
    {6, PIN_PULL_DIS, 3, "PD.1"},
    {6, PIN_PULL_DIS, 3, "PD.2"},
    {6, PIN_PULL_DIS, 3, "PD.3"},
    {6, PIN_PULL_DIS, 3, "PD.4"},
#endif
...
#endif
#if defined(AIC_PRGB_24BIT) || defined(AIC_PRGB_18BIT_LD) || defined(AIC_PRGB_18BIT_HD)
    {2, PIN_PULL_DIS, 3, "PD.6"},
    {2, PIN_PULL_DIS, 3, "PD.7"},
#endif
#if defined(AIC_PRGB_24BIT) || defined(AIC_PRGB_18BIT_LD) || defined(AIC_PRGB_18BIT_HD) || \
    defined(AIC_PRGB_16BIT_LD) || defined(AIC_PRGB_16BIT_HD)
...
#endif
#ifdef AIC_USING_I2C0
    {6, PIN_PULL_DIS, 3, "PA.8"},  // SCK
    {6, PIN_PULL_DIS, 3, "PA.9"},  // SDA
#endif
    ...
    {7, PIN_PULL_DIS, 3, "PE.12"},
    {7, PIN_PULL_DIS, 3, "PE.13"},
#endif
#ifdef AIC_USING_EPWM1
    {7, PIN_PULL_DIS, 3, "PE.10"},
    {7, PIN_PULL_DIS, 3, "PE.11"},
#endif
#ifdef AIC_USING_EPWM2
    {7, PIN_PULL_DIS, 3, "PE.8"},
    {7, PIN_PULL_DIS, 3, "PE.9"},
#endif
#ifdef AIC_USING_CAP0
    {4, PIN_PULL_DIS, 3, "PC.0"},
#endif
#ifdef AIC_USING_QEP0
    {4, PIN_PULL_DIS, 3, "PB.0"},
    {4, PIN_PULL_DIS, 3, "PB.1"},
    {4, PIN_PULL_DIS, 3, "PB.2"},
#endif
};
